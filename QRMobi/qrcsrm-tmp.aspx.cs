        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (key != "" && key != null)
            {
                ...
                if (found)
                {
                    ...
                    //switch (this.lbMake.Text.Trim().ToUpper())
                    //{
                    //    case "SAM":
                    //        this.ImageRight.ImageUrl = imgServerURL + "/OEMLOGO/SAM.PNG";
                    //        break;

                    //    case "VOLVO":
                    //        this.ImageRight.ImageUrl = imgServerURL + "/OEMLOGO/VOLVO.PNG";
                    //        break;

                    //    case "ATLAS":
                    //    case "ATLAS COPCO":

                    //        this.ImageRight.ImageUrl = imgServerURL + "";
                    //        break;

                    //    case "BELL":
                    //    case "BELLE":
                    //        this.ImageRight.ImageUrl = imgServerURL + "/OEMLOGO/Belle.PNG";

                    //        break;

                    //    case "HONDA":
                    //        this.ImageRight.ImageUrl = imgServerURL + "/OEMLOGO/Honda.PNG";

                    //        break;

                    //    case "ICS":
                    //        this.ImageRight.ImageUrl = imgServerURL + "/OEMLOGO/ICS.PNG";
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                switch (e.Row.RowIndex + 1)
                {
                    ...
                    case 1:
                        ...
                        this.latlng1.Text = e.Row.Cells[5].Text + "," + e.Row.Cells[6].Text;
                        this.add1.Text = e.Row.Cells[7].Text;
                        break;
                    case 2:

                        this.latlng2.Text = e.Row.Cells[5].Text + "," + e.Row.Cells[6].Text;
                        this.add2.Text = e.Row.Cells[7].Text;
                        break;
                    case 3:

                        this.latlng3.Text = e.Row.Cells[5].Text + "," + e.Row.Cells[6].Text;
                        this.add3.Text = e.Row.Cells[7].Text;
                        break;
                    case 4:

                        this.latlng4.Text = e.Row.Cells[5].Text + "," + e.Row.Cells[6].Text;
                        this.add4.Text = e.Row.Cells[7].Text;
                        break;
                    case 5:

                        this.latlng5.Text = e.Row.Cells[5].Text + "," + e.Row.Cells[6].Text;
                        this.add5.Text = e.Row.Cells[7].Text;
                        break;
                    case 6:

                        this.latlng6.Text = e.Row.Cells[5].Text + "," + e.Row.Cells[6].Text;
                        this.add6.Text = e.Row.Cells[7].Text;
                        break;
                    case 7:

                        this.latlng7.Text = e.Row.Cells[5].Text + "," + e.Row.Cells[6].Text;
                        this.add7.Text = e.Row.Cells[7].Text;
                        break;
                    case 8:

                        this.latlng8.Text = e.Row.Cells[5].Text + "," + e.Row.Cells[6].Text;
                        this.add8.Text = e.Row.Cells[7].Text;
                        break;
                    case 9:

                        this.latlng9.Text = e.Row.Cells[5].Text + "," + e.Row.Cells[6].Text;
                        this.add9.Text = e.Row.Cells[7].Text;
                        break;

                    case 10:

                        this.latlng10.Text = e.Row.Cells[5].Text + "," + e.Row.Cells[6].Text;
